function SearchForm() {
  return (
    <div className="searchForm">
      <form id="form" role="search" className="searchForm__form">
        <input type="search" id="query" name="q" placeholder="Фильм" aria-label="Поиск фильма" className="searchForm__form-input" />
        <button className="searchForm__form-button">
